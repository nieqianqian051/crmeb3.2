  ...
  <div class="box" v-resize="handleResize">
    ...
    <Row :gutter="24" class="ivu-mt Box">
      <Col :xl="24" :lg="24" :md="24" :sm="24" :xs="24">
        ...
        <echarts-new ref="visitChart" :option-data="optionData" :styles="style" height="100%" width="100%"
    ...
    <Row :gutter="24" class="ivu-mt">
      <Col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <Card :bordered="false" dis-hover>
          ...
          <echarts-new :option-data="circularData" :styles="style" height="100%" width="100%"
                       v-if="circularData && !orderNum"></echarts-new>
        </Card>
      </Col>
      <Col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <Card :bordered="false" dis-hover>
          ...
          <echarts-new :option-data="circularDataType" :styles="style" height="100%" width="100%"
                       v-if="circularDataType && !typeNum"></echarts-new>
        </Card>
      </Col>
    </Row>
